                          ...
                          Container(
                            ...
                            child:Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, UpcomingListPage.routeName);
                                  },
                              ...
                              if (state.state == ResultState.loading) {
                                ...
                                return Container(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemCount: state.result.items.length < 5 ? state.result.items.length : 5,
                          ...
                          Container(
                            ...
                            child:Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, InTheatersListPage.routeName);
                                  },
                                  child: const Text("See more",
                                      style: TextStyle(fontSize: 15,color: Colors.blue, fontWeight: FontWeight.bold)
                                  ),
